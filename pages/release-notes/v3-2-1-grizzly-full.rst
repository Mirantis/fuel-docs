...
This version is a maintenance release to Mirantis OpenStack 3.2 and contains defect fixes and several resolutions for issues initially reported against version 3.2.  You do not need to install version 3.2 prior to installing 3.2.1 as the 3.2.1 release is cumulative with version 3.2.

Mirantis OpenStack is a complete solution that includes three major components:
 ...
 * An open and flexible library that enables customers to make configuration 
   changes that may be more advanced or focused than the default choices within    Fuel. This library also empowers organizations to fold additional drivers 
...
packages have been synchronized with the 
`OpenStack Grizzly 2013.1.3 bug fix update <https://wiki.openstack.org/wiki/ReleaseNotes/2013.1.3>`_ .  
Fuel 3.2 will deploy this 2013.1.3 version of Grizzly 
...
Resolved Issues in Mirantis OpenStack 3.2.x
------------------------------------------
